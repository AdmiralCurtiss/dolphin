...
{
public:
  TestFres(Core::System& system, PowerPC::PowerPCState& ppc_state) : JitArm64(system, ppc_state)
  {
...
TEST(JitArm64, Fres)
{
  TestFres test(Core::System::GetInstance(), Core::System::GetInstance().GetPPCState());
