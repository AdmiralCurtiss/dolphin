...
void AchievementManager::DisplayWelcomeMessage()
{
  ...
  std::unique_ptr<OSD::Icon> icon =
      Config::Get(Config::RA_BADGES_ENABLED) ? DecodeBadgeToOSDIcon(m_game_badge.badge) : nullptr;
  if (hardcore_mode_enabled)
  {
    OSD::AddMessage(fmt::format("You have {}/{} achievements worth {}/{} points",
                                ...
                                spread.total_points),
                    OSD::Duration::VERY_LONG, OSD::Color::YELLOW, std::move(icon));
  ...
  else
  {
    OSD::AddMessage(fmt::format("You have {}/{} achievements worth {}/{} points",
                    ...
                    OSD::Duration::VERY_LONG, OSD::Color::CYAN, std::move(icon));
