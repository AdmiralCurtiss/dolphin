...
void UpdateInterrupts()
{
  ...
  {
    system.GetProcessorInterfaceState().SetInterrupt(ProcessorInterface::INT_CAUSE_VI, true);
  }
  else
  {
    system.GetProcessorInterfaceState().SetInterrupt(ProcessorInterface::INT_CAUSE_VI, false);
  }
}
